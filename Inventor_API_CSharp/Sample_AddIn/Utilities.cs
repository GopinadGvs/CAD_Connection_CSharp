...
namespace My_CSharp_AddIn
{
    public static class Utilities
    {
                                                                       ...
                                                                       string IconFolder = "")
        {
            ...
            if (!(testDef == null))
            {
                MessageBox.Show("Error when loading the add-in \"Extraction_AddIn\". A command already exists with the same internal name. Each add-in must have a unique internal name. Change the internal name in the call to CreateButtonDefinition.", "CSharp Inventor Add-In Template");
                return null;
            }
